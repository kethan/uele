...
export declare function Suspense({ fallback, children }: { fallback?: Child, children: Child }): Child;

// Switch and Match components for conditional rendering
export declare function Switch({ fallback, children }: { fallback?: Child, children: Array<() => Child> }): Child;
export declare function Match<T = {}>({ when, children }: { when: T, children: Child[] }): Child;

// Utility functions
export declare function get<T>(v: T): T;
export declare function sub(target: any): (next: (value: any) => void, error?: (err: any) => void, cleanup?: () => void) => () => void;
export declare function is(arg: any): boolean;
export declare function r(x: any, callback: (value: any, reactive: boolean) => void, error?: (err: any) => void): () => void;
// export declare function toNode(x: any): Node;
// export declare function appendChildren(fallback?: string): (...children: any[]) => Node[];

// Live utility to manage dynamic element updates
// export declare function Live(sm?: Node, em?: Node): {
//     sm: Node;
//     em: Node;
//     replace: (...xs: Node[]) => void;
// };
...
interface Api {
    ...
    any?: (target: any) => (next: (value: any) => void, error?: (err: any) => void, cleanup?: () => void) => () => void;
    is?: (v: any) => Boolean;
    get?: <T>(v: T) => T;
}
